document.addEventListener('DOMContentLoaded', () => {
    ...
    // Ajoute l'événement à tous les liens <a> (sauf ceux ouvrant dans un nouvel onglet)
    document.querySelectorAll('a').forEach(link => {
      if (link.href && (!link.target || link.target.toLowerCase() !== '_blank')) {
    ...
    // Ajoute l'événement à tous les formulaires
